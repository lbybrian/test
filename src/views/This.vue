...
import Map from '../assets/ol/Map';
import OSM from '../assets/ol/source/OSM';
import TileLayer from '../assets/ol/layer/Tile';
import View from '../assets/ol/View';
import XYZ from '../assets/ol/source/XYZ';
import { defaults as defaultControls, FullScreen, ScaleLine, ZoomSlider } from '../assets/ol/control.js';
import Projection from '../assets/ol/proj/Projection';
import { fromLonLat } from '../assets/ol/proj';
import { LineString, MultiPolygon, Point, Polygon } from "../assets/ol/geom";
import Feature from "../assets/ol/Feature";
import { Heatmap as HeatmapLayer, Vector as VectorLayer } from "../assets/ol/layer";
import { Vector as VectorSource } from "../assets/ol/source";
import { transform } from "../assets/ol/proj";
import Overlay from "../assets/ol/Overlay";
import { Circle as CircleStyle, Fill, Icon, Stroke, Style, Text } from "../assets/ol/style";
//import {} from "../assets/lib/ol.js"
...
//  cssType: Object,
  ...
  data () {
    return {
      ...
      typeArr: ['point', 'line', 'linePoint', 'animationLine', 'animationPoint', 'breathe', 'polygon'],
    }
  },
  mounted () {
...
//      return style;
    ...
    dataUpdate (geo) {
      this.$nextTick(function () {
        ...
        this.removerLayers();
        this.mapData.geojson = geo.geojson;
        geo.geojson.forEach(item => {
          ...
          if (item.type == 'flag')
            this.showIcon(item, this.map, "flag");
